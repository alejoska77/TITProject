...
public class activity_emociones4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String username= intent.getStringExtra(activity_emociones3.user);
        // final String username= intent.getStringExtra(Ruleta.usernames);
        ...
        final String pregunta="En que situación sentirias Estres";
        ...
        imgCorrecto=findViewById(R.id.imgCorrectoem4);

        imgIncorrecto=findViewById(R.id.imginCorrectoem4);
        imageViewres2p1=findViewById(R.id.imageViewres4p1);
        imageViewres2p2=findViewById(R.id.imageViewres4p2);
        ...
        imageViewres2p2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(activity_emociones4.this, activity_emociones5.class);
