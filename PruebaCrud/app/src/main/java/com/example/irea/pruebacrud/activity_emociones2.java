...
public class activity_emociones2 extends AppCompatActivity {
...
final     Intent intent = getIntent();
        ...
        final String username= intent.getStringExtra(activity_emociones1.user);
        // final String username= intent.getStringExtra(Ruleta.usernames);
      //  String userid= intent.getStringExtra(Ruleta.userid);
        ...
        final String pregunta="En que situación sentirias Soledad";
        ...
        imgCorrecto=findViewById(R.id.imgCorrectoem2);

        imgIncorrecto=findViewById(R.id.imginCorrectoem2);
        imageViewres2p1=findViewById(R.id.imageViewres2p1);
        imageViewres2p2=findViewById(R.id.imageViewres2p2);
        ...
        imageViewres2p1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(activity_emociones2.this, activity_emociones3.class);
