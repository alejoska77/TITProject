...
public class activity_emociones6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emociones6);

        final     Intent intent = getIntent();
        //final String username= intent.getStringExtra(Ruleta.usernames);
        final String username= intent.getStringExtra(activity_emociones5.user);
        // final String username= intent.getStringExtra(Ruleta.usernames);
        ...
        final String pregunta="En que situación sentirias Amor";
        ...
        imgCorrecto=findViewById(R.id.imgCorrectoem6);

        imgIncorrecto=findViewById(R.id.imginCorrectoem6);
        imageViewres2p1=findViewById(R.id.imageViewres6p1);
        imageViewres2p2=findViewById(R.id.imageViewres6p2);
        ...
        imageViewres2p1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(activity_emociones6.this, activity_emocion7.class);
