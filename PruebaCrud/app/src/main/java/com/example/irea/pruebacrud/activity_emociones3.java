...
public class activity_emociones3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String username= intent.getStringExtra(activity_emociones2.user);
        // final String username= intent.getStringExtra(Ruleta.usernames);
        ...
        final String pregunta="En que situación sentirias Miedo";
        ...
        imgCorrecto=findViewById(R.id.imgCorrectoem3);

        imgIncorrecto=findViewById(R.id.imginCorrectoem3);

        imageViewres2p1=findViewById(R.id.imageViewres3p1);
        imageViewres2p2=findViewById(R.id.imageViewres3p2);
        ...
        imageViewres2p1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(activity_emociones3.this, activity_emociones4.class);
