...
private String TAG="PresentadorRegistro";
    ...
    public void signUpUser(final String email, final String password, final String nombreCompleto, final String username, final  String uid, final  String rol){
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            mDatabase.child("Usuario").child(task.getResult().getUser().getUid()).updateChildren(crearUsuario);
