...
public class activity_emocion7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emociones7);

        final     Intent intent = getIntent();
        //final String username= intent.getStringExtra(Ruleta.usernames);
        final String username= intent.getStringExtra(activity_emociones6.user);
        // final String username= intent.getStringExtra(Ruleta.usernames);
        ...
        // String userid= intent.getStringExtra(Ruleta.userid);
        final String fraseimportada="PREGUNTA 7";

        final String pregunta="En que situación sentirias Sorpresa";
        ...
        imgCorrecto=findViewById(R.id.imgCorrectoem7);

        imgIncorrecto=findViewById(R.id.imginCorrectoem7);
        imageViewres2p1=findViewById(R.id.imageViewres7p1);
        imageViewres2p2=findViewById(R.id.imageViewres7p2);
        ...
        imageViewres2p1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Emociones ss = new Emociones();
                ss.setId(username);
                ss.setTotal(totalPunto);

                databaseReference.child("ResultadosEmociones").child(ss.getId()).setValue(ss);

                Intent intent= new Intent(activity_emocion7.this, activity_final.class);
