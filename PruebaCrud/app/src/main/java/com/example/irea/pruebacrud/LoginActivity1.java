...
*/
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            databaseReference = FirebaseDatabase.getInstance().getReference().child("Usu");//Refrenciar base de datos a la tabla Users creada
                            ...
                            final ValueEventListener valueEventListener = databaseReference.child(firebaseAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    Persona user = dataSnapshot.getValue(Persona.class);{
                                        user.getRol();
                                        if (user.getRol().equals("User") || user.getRol().equals("Usuario")) {

                                            //startActivity(new Intent(getApplicationContext(), activity_main_use.class));
                                            Intent intent2 = new Intent(getApplicationContext(), activity_main_use.class);


                                            intent2.putExtra(username, user.getNombre());
                                        ...
                                        if (user.getRol().equals("Admin") || user.getRol().equals("Administrador")){
                                            startActivity(new Intent(getApplicationContext(), ActivityMainAdmin.class));
                            ...
                            Toast.makeText(LoginActivity1.this, "Usuario o Contraseña incorrectos", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    public void onClick(View view) {
        ...
        if (view == textViewRegistrar) {
            startActivity(new Intent(this, regis.class));//Abrir  pantalla para el registro
