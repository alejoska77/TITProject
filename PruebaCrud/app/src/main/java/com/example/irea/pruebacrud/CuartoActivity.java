...
public class CuartoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String fraseimportada="PREGUNTA 4";
        final String pregunta="Que haria si su novi@ lo traiciona";
...
//        final String username= intent.getStringExtra(Ruleta.usernames);
        ...
        radioGroup = (RadioGroup) findViewById(R.id.rbgpreguntas4);

        radioopone = (RadioButton) findViewById(R.id.radioButton42);
        radiooptwo = (RadioButton) findViewById(R.id.radioButton43);
        radioopThree = (RadioButton) findViewById(R.id.radioButton44);

        num = (TextView)findViewById(R.id.txtCuarto);
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (selectedId){
                    ...
                    case R.id.radioButton42:
                        ...
                        r.setId(username);
                        r.setDescripcion("Me alejaria de ellos, se que encontrare alguien mejor");
                        r.setPuntuacion("5");
                        ...
                        // Intent intent= new Intent(CuartoActivity.this, Ruleta.class);
                        Intent intent= new Intent(CuartoActivity.this, SextoActivity.class);
                    ...
                    case R.id.radioButton43:
                        ...
                        rr.setId(username);
                        rr.setDescripcion("Los reclamaria por traicionarme");
                        rr.setPuntuacion("3");
                        //rr.puntajeto[4]=3;
                        ...
                        // Intent intent2= new Intent(CuartoActivity.this, Ruleta.class);
                        Intent intent2= new Intent(CuartoActivity.this, SextoActivity.class);
                    ...
                    case R.id.radioButton44:
                        ...
                        rer.setId(username);
                        rer.setDescripcion("Me pondria a llorar");
                        rer.setPuntuacion("1");
                        //rer.puntajeto[4]=1;
                        ...
                        // Intent intent3= new Intent(CuartoActivity.this, Ruleta.class);
                        Intent intent3= new Intent(CuartoActivity.this, SextoActivity.class);
